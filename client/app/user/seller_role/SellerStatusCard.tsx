        ...
        return (
          <div className="space-y-4">
            ...
            <button
              onClick={onAction}
              disabled={isLoading}
              className="mt-4 px-6 py-2.5 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
