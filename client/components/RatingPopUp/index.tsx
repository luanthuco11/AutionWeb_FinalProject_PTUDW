...
export default function RatingPopup({ isOpen, onClose, onSubmit, buyerName }: RatingPopupProps) {
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className="bg-white w-[370px] rounded-xl shadow-lg p-5 relative fade-in">
                ...
                <div className="flex justify-center gap-4 mb-4 text-xl">
                    <button
                        onClick={() => setRating(1)}
                        className={`px-4 py-2 rounded-md font-semibold border ${rating === 1 ? "bg-teal-600 text-white" : "bg-gray-200 text-gray-700"
                            }`}
                    >
                        +
                    </button>
                    <button
                        onClick={() => setRating(-1)}
                        className={`px-4 py-2 rounded-md font-semibold border ${rating === -1 ? "bg-red-600 text-white" : "bg-gray-200 text-gray-700"
                            }`}
                    >
                        -
                    </button>
